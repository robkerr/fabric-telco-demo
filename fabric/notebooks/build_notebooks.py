...
def nb_05():
    ...
    return notebook([
        ...
        code("# Show the available element tree so you can see valid table paths.",
             "print('--- datasource tree (before select) ---')",
             "try:",
             "    ds.pretty_print()",
             "except Exception as _ex:",
             "    print('pretty_print unavailable:', _ex)"),
        code("def _try_select(*path):",
             "    try:",
             "        ds.select(*path)",
             "        return True",
             "    except Exception:",
        ...
        code("# Datasource instructions.",
             ...
             "except Exception:",
             "    pass"),
        code("agent.publish_staging(description=DESCRIPTION)",
